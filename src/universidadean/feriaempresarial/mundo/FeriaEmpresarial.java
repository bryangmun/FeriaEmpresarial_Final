...
public class FeriaEmpresarial {
    ...
    */
    ...
    public String metodo1() {
        int puestosOcupadosNorte = 0;
        int puestosOcupadosSur = 0;
        int puestosOcupadosOriente = 0;
        int puestosOcupadosOccidente = 0;
        int puestosOcupadosCentro = 0;
        String respuesta = null;
        String zona;
        for (Puesto puesto: puestos){
            zona = Puesto.ZONA_SUR;
            if (puesto.darZona().equals(zona)) {
                puestosOcupadosSur += darExpositoresPuesto(puesto.darNumero(),zona);
            }
        }
        for (Puesto puesto: puestos){
            zona = Puesto.ZONA_NORTE;
            if (puesto.darZona().equals(zona)) {
                puestosOcupadosNorte += darExpositoresPuesto(puesto.darNumero(),zona);
            }
        }
        for (Puesto puesto: puestos){
            zona = Puesto.ZONA_ORIENTE;
            if (puesto.darZona().equals(zona)) {
                puestosOcupadosOriente += darExpositoresPuesto(puesto.darNumero(),zona);
            }
        }
        for (Puesto puesto: puestos){
            zona = Puesto.ZONA_OCCIDENTE;
            if (puesto.darZona().equals(zona)) {
                puestosOcupadosOccidente += darExpositoresPuesto(puesto.darNumero(),zona);
            }
        }
        for (Puesto puesto: puestos){
            zona = Puesto.ZONA_CENTRO;
            if (puesto.darZona().equals(zona)) {
                puestosOcupadosCentro += darExpositoresPuesto(puesto.darNumero(),zona);
            }
        }
        int maxPuesto = Math.max(puestosOcupadosNorte, Math.max(puestosOcupadosCentro, Math.max(puestosOcupadosOccidente, Math.max(puestosOcupadosOriente, puestosOcupadosSur))));
        if (maxPuesto == puestosOcupadosOriente){
            respuesta = "La zona Oriente es la que tiene mas cantidad de expositores";
        }
        if (maxPuesto == puestosOcupadosOccidente){
            respuesta = "La zona Occidente es la que tiene mas cantidad de expositores";
        }
        if (maxPuesto == puestosOcupadosNorte){
            respuesta = "La zona Norte es la que tiene mas cantidad de expositores";
        }
        if (maxPuesto == puestosOcupadosSur){
            respuesta = "La zona Sur es la que tiene mas cantidad de expositores";
        }
        if (maxPuesto == puestosOcupadosCentro){
            respuesta = "La zona Centro es la que tiene mas cantidad de expositores";
        }
        return respuesta;
    ...
    public String metodo2() {
        double porcentajeExpositores = 0;
        int totalExpositores = 0;
        int numExpositoresNorte = 0;
        int numExpositoresSur = 0;
        int numExpositoresOriente = 0;
        int numExpositoresOccidente = 0;
        int numExpositoresCentro = 0;
        int numExpositores = 0;
        String zona;
        String respuesta;
        ...
        for (Puesto puesto : puestos) {
            zona = Puesto.ZONA_NORTE;
            if (puesto.darZona().equals(zona)){
                numExpositoresNorte += darExpositoresPuesto(puesto.darNumero(), zona);
                totalExpositores += puesto.darNumMaximoPersonas();
            }
        }
        for (Puesto puesto : puestos) {
            zona = Puesto.ZONA_SUR;
            if (puesto.darZona().equals(zona)){
                numExpositoresSur += darExpositoresPuesto(puesto.darNumero(), zona);
                totalExpositores += puesto.darNumMaximoPersonas();
            }
        }
        for (Puesto puesto : puestos) {
            zona = Puesto.ZONA_ORIENTE;
            if (puesto.darZona().equals(zona)){
                numExpositoresOriente += darExpositoresPuesto(puesto.darNumero(), zona);
                totalExpositores += puesto.darNumMaximoPersonas();
            }
        }
        for (Puesto puesto : puestos) {
            zona = Puesto.ZONA_OCCIDENTE;
            if (puesto.darZona().equals(zona)){
                numExpositoresOccidente += darExpositoresPuesto(puesto.darNumero(), zona);
                totalExpositores += puesto.darNumMaximoPersonas();
            }
        }
        for (Puesto puesto : puestos) {
            zona = Puesto.ZONA_CENTRO;
            if (puesto.darZona().equals(zona)){
                numExpositoresCentro += darExpositoresPuesto(puesto.darNumero(), zona);
                totalExpositores += puesto.darNumMaximoPersonas();
            }
        }
        numExpositores = numExpositoresCentro + numExpositoresNorte + numExpositoresOccidente + numExpositoresOriente + numExpositoresSur;
        porcentajeExpositores = (double) numExpositores / totalExpositores;
        porcentajeExpositores = porcentajeExpositores * 100;
        if (porcentajeExpositores >= 60.00 ) {
            respuesta = "El punto de equilibrio se ha cumplido";
        } else {
            respuesta = "El punto de equilibrio no se ha cumplido";
        }
        return respuesta;
    }
}
